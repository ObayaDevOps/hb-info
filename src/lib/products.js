...
export const PRODUCTS = [
  ...
  // ---------- CANDLES, GIFTS & COSMETICS ----------
  {
    ...
    shortName: 'Lemongrass & Ginger Candle',
    category: 'candles',
    ...
    related: ['lavender-chamomile-vanilla-beeswax-candle', 'taster-gift-set', 'beeswax-lip-balm'],
  },
  {
    slug: 'lavender-chamomile-vanilla-beeswax-candle',
    name: 'Natural Beeswax Candle: Lavender, Chamomile & Vanilla',
    shortName: 'Lavender, Chamomile & Vanilla Candle',
    category: 'candles',
    categoryLabel: 'Beeswax Candles',
    bestSeller: false,
    price: 70000,
    size: '220g · ~60 hour burn',
    image: '/images/products/beeswax-candle-lavender-chamomile-vanilla.jpg',
    imageAlt: 'Humble Beeing lavender, chamomile and vanilla natural beeswax candle in a black jar with bamboo lid on a woven Ugandan basket',
    tagline: 'Hand-poured pure beeswax from our own hives, with a calming floral scent made for winding down.',
    tastingNotes: ['Coconut & peach sweetness', 'Lavender, lilac & chamomile heart', 'Cedarwood & vanilla base'],
    origin: {
      region: 'Hand-poured in Kampala',
      floralSource: 'Pure beeswax from our partner apiaries in West Nile',
      harvest: 'Wax caps filtered through organic cotton, poured in small batches',
    ...
    story: [
      'Every honey harvest leaves behind golden beeswax caps; we filter them through organic cotton and hand-pour them into candles in Kampala. Nothing is wasted, and no paraffin ever touches our wicks.',
      'Coconut and peach top notes for sweetness; floral middle notes of lavender, lilac, and chamomile; comforting base notes of cedarwood and vanilla. This is the candle we reach for at the end of the day, when the house goes quiet.',
    ],
    process: [
      { title: 'Wax from our own harvests', text: 'Beeswax caps from the same West Nile hives that give us our honey: fully traceable.' },
      { title: 'Filtered & hand-poured', text: 'Filtered through organic cotton to keep the natural golden sheen, then poured in small batches in Kampala.' },
    ...
    tryItWith: [
      ...
      { title: 'A long bath', text: 'A steady beeswax flame and a vanilla-cedarwood base turn an ordinary bath into a proper reset.' },
      { title: 'Reading corner', text: 'Soft floral notes that stay in the background: company for a book, not a distraction from it.' },
      { title: 'Paired with our honey', text: 'A candle and a jar of infused honey is our most-given gift combination.' },
    ],
    healthBenefits: [
      { title: 'Naturally air-purifying', text: 'Burning beeswax releases negative ions that can help reduce dust and allergens in indoor air.' },
    ...
    faqs: [
      ...
      {
        q: 'Is the fragrance natural?',
        a: 'The scent comes from essential-oil blends (coconut and peach top notes, a lavender, lilac, and chamomile heart, and a cedarwood and vanilla base) in a pure beeswax body.',
      },
    ],
    related: ['beeswax-candle', 'taster-gift-set', 'vanilla-bean-infused-honey'],
  },
  {
    slug: 'beeswax-lip-balm',
    name: 'Natural Beeswax Lip Care',
    shortName: 'Beeswax Lip Care',
    category: 'cosmetics',
    categoryLabel: 'Beeswax Cosmetics',
    bestSeller: false,
    price: 12000,
    size: '15g tin',
    image: '/images/products/beeswax-lip-balm.jpg',
    imageAlt: 'Humble Beeing organic beeswax lip care tin on a woven Ugandan basket, handmade in Kampala',
    tagline: 'Pure West Nile beeswax, shea butter, and coconut oil: nothing you couldn’t eat.',
    tastingNotes: ['Unscented honey warmth', 'Silky, not waxy', 'All-day protection'],
    origin: {
      region: 'Made in Kampala',
      floralSource: 'Pure beeswax from our partner apiaries, blended with shea butter and coconut oil',
      harvest: 'Small batches, poured by hand',
    },
    story: [
      'The same golden beeswax that seals our honeycomb makes the best natural lip protection there is. We blend it with shea butter and coconut oil into a simple, honest balm: no petroleum jelly, no synthetic fragrance, nothing you couldn’t safely eat.',
      'Each ingredient earns its place in the tin. Beeswax forms a breathable seal that holds moisture against the skin without suffocating it. Shea butter feeds the skin barrier itself: its oleic and stearic acids replenish the lipids that dry, cracked lips have lost, and its natural triterpenes and cinnamic acid esters calm irritation while the barrier recovers. Coconut oil melts straight into that lipid layer; roughly half of it is lauric acid, which softens skin, slows water loss, and has natural antimicrobial properties that help protect broken skin as it heals.',
    ...
    process: [
      ...
      { title: 'Simple, natural formula', text: 'Beeswax, shea butter, and coconut oil: a short ingredient list you can actually read.' },
      { title: 'Hand-poured in Kampala', text: 'Made in small batches at our Kampala facility.' },
    ],
    tryItWith: [
      { title: 'Daily carry', text: 'Kampala sun and long matatu rides are hard on lips: keep a tin in your bag. Beeswax stays solid until around 63°C, so it will not melt and leak in your bag the way softer balms do.' },
      { title: 'Overnight repair', text: 'A generous layer before bed works while you sleep.' },
      { title: 'Cuticles & dry patches', text: 'It is a balm for more than lips; use it anywhere skin needs a barrier.' },
      { title: 'In a gift set', text: 'Pairs perfectly with a candle and a jar of honey for a full hive-to-home gift.' },
    ],
    healthBenefits: [
      { title: 'Beeswax: breathable barrier', text: 'Beeswax is a natural occlusive shown to reduce water loss through the skin. It seals moisture in while still letting skin breathe, and brings vitamin A and mild anti-inflammatory properties that calm chapped lips.' },
      { title: 'Shea butter: barrier repair', text: 'Rich in the oleic and stearic acids the skin barrier is built from, shea butter restores lost lipids and elasticity, while its triterpenes and cinnamic acid esters soothe inflammation. Studies show it measurably cuts water loss and boosts hydration.' },
      { title: 'Coconut oil: deep moisture', text: 'Clinical trials found coconut oil improves hydration and barrier function as well as or better than mineral oil. Its lauric acid absorbs into the lipid layer and converts to monolaurin, a natural antimicrobial that helps protect cracked lips.' },
