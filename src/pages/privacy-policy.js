...
const fallbackSections = [
  { id: 'privacyPolicy1', title: 'Privacy Policy 1' },
  { id: 'privacyPolicy2', title: 'Privacy Policy 2' },
  { id: 'privacyPolicy3', title: 'Privacy Policy 3' },
  { id: 'privacyPolicy4', title: 'Privacy Policy 4' },
  { id: 'privacyPolicy5', title: 'Privacy Policy 5' },
  { id: 'privacyPolicy6', title: 'Privacy Policy 6' },
  { id: 'privacyPolicy7', title: 'Privacy Policy 7' },
];
...
export default function TermsPage({ pageData }) {
  ...
  const title = pageData?.title || 'Our Privacy Policy';
  const subtitle = pageData?.subtitle || 'Our Terms';
  const metaDescription = pageData?.metaDescription || 'Our Full Privacy Policy';
